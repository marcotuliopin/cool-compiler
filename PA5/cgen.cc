...
CgenClassTable::CgenClassTable(Classes classes, ostream &s) : nds(NULL), str(s)
{
  ...
  classtags.insert(std::make_pair(Bool, boolclasstag));
  classtags.insert(std::make_pair(IO, ioclasstag));
  classtags.insert(std::make_pair(Object, objectclasstag));

  // Set tag for other classes.
  int i = classes->first();
...
///////////////////////////////////////////////////////////////////////
//
// CgenClassTable helper functions
//
///////////////////////////////////////////////////////////////////////
...
void get_methods(CgenNodeP nd, std::vector<std::pair<Class_, method_class *>> &methods)
{
  ...
  for (int i = features->first(); features->more(i); i = features->next(i))
  {
    ...
    if (!name_already_exists)
      methods.push_back(std::make_pair(nd, method));
  }
}
...
void CgenClassTable::emit_dispatchtables()
{
  ...
  while (!q.empty())
  {
    ...
    get_methods(currnd, currnd->all_methods);
